...
from models import Contact, IntegrationAuditLog, ContactDuplicateExclusion, SegmentMember
...
def _repoint_contact_references(old_id: int, new_id: int) -> dict[str, int]:
    ...
    for mapper in db.Model.registry.mappers:
        ...
        if table.name in {Contact.__tablename__, SegmentMember.__tablename__}:
            continue
