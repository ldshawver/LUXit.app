...
class Contact(db.Model):
    ...
    identity_verification_source = db.Column(db.String(80), nullable=True)
    identity_requested_fields = db.Column(db.JSON, default=list, nullable=False)
    identity_request_state = db.Column(db.JSON, default=dict, nullable=False)
    identity_fields_requested_at = db.Column(db.DateTime, nullable=True)
    identity_last_request_sid = db.Column(db.String(64), nullable=True)
    identity_last_response_sid = db.Column(db.String(64), nullable=True)
    identity_conflict_status = db.Column(db.String(32), default="none", nullable=False, index=True)
    identity_conflict_details = db.Column(db.JSON, default=dict, nullable=False)
    ...
    approval_source = db.Column(db.String(80), nullable=True)
    approval_match_source = db.Column(db.String(80), nullable=True)
    approval_rejected_at = db.Column(db.DateTime, nullable=True)
...
class SMSCampaign(db.Model):
    ...
    scheduled_unique_phone_count = db.Column(db.Integer)
    scheduled_eligible_recipient_count = db.Column(db.Integer)
    execution_recipient_count = db.Column(db.Integer)
    execution_count_delta = db.Column(db.Integer)
    scheduled_timezone = db.Column(db.String(80), default="UTC")
    scheduled_by_user_id = db.Column(db.Integer, db.ForeignKey("user.id"), nullable=True)
    recipient_resolution = db.Column(JSON, default=dict)
...
class PWADevice(db.Model):
    ...
    lifecycle_status = db.Column(db.String(20), default="pending", nullable=False, index=True)
